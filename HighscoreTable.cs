...
public class HighscoreTable : MonoBehaviour {
    ...
    private void Awake() {
        ...
        //PlayerPrefs.DeleteAll(); //모두 삭제해버리깅
        /*if (highscores == null) {
...
*/
 ...
 entryTransform.Find("timeText").GetComponent<Text>().text=time.ToString();
    ...
    public void AddHighscoreEntry(string name) {
        ...
        HighscoreEntry highscoreEntry = new HighscoreEntry { score = CountScore.score, time=Mathf.Round(CountScore.time*10)*0.1f,name = name };
